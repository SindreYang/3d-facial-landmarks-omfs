...
class HeadspaceDataLoader(Dataset):
    def __init__(self, root, args, split='train', process_data=False):
        self.root = root
        self.npoints = args.num_point
        self.process_data = process_data
        ...
        self.catfile = os.path.join(self.root, 'headspace_shape_names.txt')
        ...
        if self.uniform:
            ...
            self.save_path = os.path.join(root, 'headspace%d_%s_%dpts.dat' % (self.num_category, split, self.npoints))
...
if __name__ == '__main__':
    ...
    data = HeadspaceDataLoader('/data/headspace/', split='train')
