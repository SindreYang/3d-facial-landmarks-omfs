...
class ClassifierModel:
    ...
    def set_input(self, data):
        ...
        #labels = torch.ones(16,3) #4 [-32.064659, -41.070557,  39.225555]
        #labels = torch.tensor([[-39.263191, -31.227459,  30.902531],
        #                       [-39.059505, -24.339855,  43.244362],
        #                       [-39.807362, -43.25309, 60.427628],
        #                       [-32.064659, -41.070557, 39.225555]
        #                       ])
        # set inputs
...
##################
    ...
    def get_accuracy(self, pred, labels):
        ...
        if self.opt.dataset_mode == 'classification':
            ...
            pred = pred.float()
            correct = sum((pred-labels)**2) # is actually sum of squared error, not acc
        return correct
